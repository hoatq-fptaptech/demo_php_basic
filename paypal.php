...
$success_url = 'http://localhost/success_paypal.php';
$cancel_url = 'http://localhost/cancel_paypal.php';
...
// Hàm tạo thanh toán
function create_payment($access_token, $success_url,$cancel_url) {
    $ch = curl_init();
...
// Tạo thanh toán
$payment = create_payment($access_token, $success_url,$cancel_url);
